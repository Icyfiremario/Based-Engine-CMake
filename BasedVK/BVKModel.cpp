...
namespace std
{
    ...
    struct hash<BVKModel::Vertex>
    {
        ...
        {
            size_t seed = 0;
            BasedVK::Utils::hashCombine(seed, vertex.position);
            BasedVK::Utils::hashCombine(seed, vertex.color);
            BasedVK::Utils::hashCombine(seed, vertex.normal);
            BasedVK::Utils::hashCombine(seed, vertex.uv);
            return seed;
        }
    };
};
