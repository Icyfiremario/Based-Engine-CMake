...
void BECamera::setOrthoGraphicProjection(float left, float right, float top, float bottom, float near, float far)
{
...
void BECamera::setPerspectiveProjection(float fovy, float aspect, float near, float far)
{
